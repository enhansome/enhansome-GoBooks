...
[![Validate README](https://github.com/dariubs/GoBooks/actions/workflows/validate.yml/badge.svg)](https://github.com/dariubs/GoBooks/actions/workflows/validate.yml) ⭐ 19,607 | 🐛 0 | 🌐 Go | 📅 2026-07-13 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,146 | 🐛 100 | 📅 2026-06-30
...
*Last published*: **2025**
*Authors:* **Chris James**
*Avaible For Free* : **[Source Code](https://github.com/quii/learn-go-with-tests) ⭐ 23,812 | 🐛 79 | 🌐 Go | 📅 2026-08-10**
...
*Avaible For Free* : **[Source Code](https://github.com/pazams/go-for-javascript-developers) ⭐ 1,240 | 🐛 2 | 🌐 HTML | 📅 2024-10-02**
...
### [Practical guide for building a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 551 | 🐛 0 | 🌐 Go | 📅 2025-08-17 *Free*
...
The book is based on a [real open source project](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,408 | 🐛 30 | 🌐 Go | 📅 2025-11-03.
...
### [Webapps in Go the anti textbook](https://github.com/thewhitetulip/web-dev-golang-anti-textbook) ⭐ 3,247 | 🐛 9 | 🌐 Go | 📅 2025-09-30 *Free*
...
### [More Books on the Go Wiki](https://github.com/golang/go/wiki/Books) ⭐ 135,744 | 🐛 10,228 | 🌐 Go | 📅 2026-08-13
...
* [PostgreSQL Books](https://github.com/sara8086/PostgresBooks) ⭐ 116 | 🐛 1 | 📅 2026-02-24 – A curated list of books and guides for PostgreSQL
* [AI Books](https://github.com/mahseema/aibooks) ⭐ 86 | 🐛 0 | 📅 2025-08-03 – A curated collection of books and resources on artificial intelligence
* [Dev Books](https://github.com/devtoolsd/DevBooks) ⭐ 84 | 🐛 0 | 📅 2026-04-15 – A collection of development and programming books
* [Python Books](https://github.com/lara-west/PythonBooks) ⭐ 53 | 🐛 0 | 📅 2026-02-10 – A comprehensive list of Python books and tutorials

# Contributing

Your contributions are always welcome, just follow [the rules](https://github.com/dariubs/GoBooks/blob/master/CONTRIBUTING.md) ⭐ 19,607 | 🐛 0 | 🌐 Go | 📅 2026-07-13!
